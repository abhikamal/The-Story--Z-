      ...
      <section className="hero-section section flex-center" style={{ minHeight: '90vh', position: 'relative', overflow: 'hidden' }}>
        <div className="container" style={{ position: 'relative', zIndex: 10 }}>
          <div className="grid" style={{ gridTemplateColumns: '1fr 1fr', alignItems: 'center', gap: '4rem' }}>
            ...
            <div className="hero-image glass-card" style={{ height: '500px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column', gap: '1rem', background: 'linear-gradient(145deg, var(--surface-color), var(--surface-accent))' }}>
